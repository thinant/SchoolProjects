...
void timSoLonNhatTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot, unsigned int& viTriDongLonNhat, unsigned int& viTriCotLonNhat);

int main()
{
	MANG2D_NGUYEN maTran{ 0 };
	unsigned int soDong = 0, soCot = 0, viTriDongLonNhat = 0, viTriCotLonNhat = 0;
	...
	timSoLonNhatTrenMaTran(maTran, soDong, soCot, viTriDongLonNhat, viTriCotLonNhat);

	printf("Phan tu lon nhat trong ma tran la: %d, o vi tri [%u][%u]", 
		maTran[viTriDongLonNhat][viTriCotLonNhat], viTriDongLonNhat, viTriCotLonNhat);
...
void timSoLonNhatTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot, 
	unsigned int& viTriDongLonNhat, unsigned int& viTriCotLonNhat)
{
	viTriDongLonNhat = 0, viTriCotLonNhat = 0;

	for (unsigned int i = 0; i < soDong; i++)
		for (unsigned int j = 0; j < soCot; j++)
			if (maTran[i][j] > maTran[viTriDongLonNhat][viTriCotLonNhat])
				viTriDongLonNhat = i, viTriCotLonNhat = j;
}