...
void timSoChanCuoiCungTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot, unsigned int& viTriDongChanCuoiCung, unsigned int& viTriCotChanCuoiCung);

int main()
{
	MANG2D_NGUYEN maTran{ 0 };
	unsigned int soDong = 0, soCot = 0, viTriDongChanCuoiCung = 0, viTriCotChanCuoiCung = 0;
...
void timSoChanCuoiCungTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot,
	unsigned int& viTriDongChanCuoiCung, unsigned int& viTriCotChanCuoiCung)
{
