...
void timSoNhoNhatTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot, unsigned int& viTriDongNhoNhat, unsigned int& viTriCotNhoNhat);

int main()
{
	MANG2D_NGUYEN maTran{ 0 };
	unsigned int soDong = 0, soCot = 0, viTriDongNhoNhat = 0, viTriCotNhoNhat = 0;
	...
	timSoNhoNhatTrenMaTran(maTran, soDong, soCot, viTriDongNhoNhat, viTriCotNhoNhat);

	printf("Phan tu nho nhat trong ma tran la: %d, o vi tri [%u][%u]",
		maTran[viTriDongNhoNhat][viTriCotNhoNhat], viTriDongNhoNhat, viTriCotNhoNhat);
...
void timSoNhoNhatTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot,
	unsigned int& viTriDongNhoNhat, unsigned int& viTriCotNhoNhat)
{
	viTriDongNhoNhat = 0, viTriCotNhoNhat = 0;

	for (unsigned int i = 0; i < soDong; i++)
		for (unsigned int j = 0; j < soCot; j++)
			if (maTran[i][j] < maTran[viTriDongNhoNhat][viTriCotNhoNhat])
				viTriDongNhoNhat = i, viTriCotNhoNhat = j;
}