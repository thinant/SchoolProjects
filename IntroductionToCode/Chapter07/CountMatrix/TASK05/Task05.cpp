...
unsigned int demPhanTuNguyenToTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot);
bool kiemTraSoNguyenTo(int so);

int main()
{
	MANG2D_NGUYEN maTran{ 0 };
	unsigned int soDong = 0, soCot = 0, soPhanTuNguyenTo = 0;
	...
	soPhanTuNguyenTo = demPhanTuNguyenToTrenMaTran(maTran, soDong, soCot);

	printf("\nMang co %d phan tu nguyen to.", soPhanTuNguyenTo);
