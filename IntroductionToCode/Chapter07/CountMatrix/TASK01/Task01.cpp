...
void demPhanTuAmDuongTrenMaTran(MANG2D_THUC maTran, unsigned int soDong, unsigned int soCot, unsigned int& soPhanTuAm, unsigned int& soPhanTuDuong);
void xuatMangThuc(double mangThuc[], unsigned int soPhanTu);

int main()
{
	MANG2D_THUC maTran{ 0 };
	unsigned int soDong = 0, soCot = 0, soPhanTuAm = 0, soPhanTuDuong = 0;
	...
	demPhanTuAmDuongTrenMaTran(maTran, soDong, soCot, soPhanTuAm, soPhanTuDuong);

	printf("\nMang co %d phan tu am va %d phan tu duong.", soPhanTuAm, soPhanTuDuong);
