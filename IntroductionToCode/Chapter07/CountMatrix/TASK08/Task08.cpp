...
unsigned int demPhanTuCucTriTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot);

int main()
{
	MANG2D_NGUYEN maTran{ 0 };
	unsigned int soDong = 0, soCot = 0, soPhanTuCucTri = 0;
	...
	soPhanTuCucTri = demPhanTuCucTriTrenMaTran(maTran, soDong, soCot);

	printf("\nMang co %d phan tu cuc tri.", soPhanTuCucTri);
