...
unsigned int demPhanTuCucTieuTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot);

int main()
{
	MANG2D_NGUYEN maTran{ 0 };
	unsigned int soDong = 0, soCot = 0, soPhanTuCucTieu = 0;
	...
	soPhanTuCucTieu = demPhanTuCucTieuTrenMaTran(maTran, soDong, soCot);

	printf("\nMang co %d phan tu cuc tieu.", soPhanTuCucTieu);
...
unsigned int demPhanTuCucTieuTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot)
{
	unsigned int soPhanTuCucTieu = 0;
