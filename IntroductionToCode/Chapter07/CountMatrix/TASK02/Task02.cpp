...
void demPhanTuChanLeTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot, unsigned int& soPhanTuChan, unsigned int& soPhanTuLe);

int main()
{
	MANG2D_NGUYEN maTran{ 0 };
	unsigned int soDong = 0, soCot = 0, soPhanTuChan = 0, soPhanTuLe = 0;
	...
	demPhanTuChanLeTrenMaTran(maTran, soDong, soCot, soPhanTuChan, soPhanTuLe);

	printf("\nMang co %d phan tu chan va %d phan tu le.", soPhanTuChan, soPhanTuLe);
