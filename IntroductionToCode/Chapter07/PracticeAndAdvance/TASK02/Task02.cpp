...
bool kiemTraMaTranDoiXung(MANG2D_THUC maTran, unsigned int soDong);
int main()
{
	...
	if (kiemTraMaTranDoiXung(maTran, soDong))
		printf("Ma tran doi xung qua duong cheo chinh.");
	else printf("Ma tran khong doi xung qua duong cheo chinh.");
