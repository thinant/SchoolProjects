...
void xuatPhanTuCoKySoCuoiLa5(MANG2D_NGUYEN_DUONG maTran, unsigned int soDong, unsigned int soCot);
...
int main()
{
	...
	printf("Cac phan tu co ky so tan cung la 5: ");
	xuatPhanTuCoKySoCuoiLa5(maTran, soDong, soCot);
