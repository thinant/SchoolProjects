...
double tinhTongGiaTriLonNhatDongTrenMaTran(MANG2D_NGUYEN maTran, unsigned int soDong, unsigned int soCot);

int main()
{
	MANG2D_NGUYEN maTran{ 0 };
	unsigned int soDong = 0, soCot = 0;
	double tongGiaTriLonNhatDong = 0;
	...
	tongGiaTriLonNhatDong = tinhTongGiaTriLonNhatDongTrenMaTran(maTran, soDong, soCot);

	printf("Tong phan tu lon nhat moi dong trong ma tran la: %lf", tongGiaTriLonNhatDong);
...
{
	double tongGiaTriLonNhatDong = 0;
	double giaTriLonNhatDong = 0;
	for (unsigned int i = 0; i < soDong; i++)
	{
		giaTriLonNhatDong = maTran[i][0];
		for (unsigned int j = 1; j < soCot; j++)
			if (maTran[i][j] > giaTriLonNhatDong) 
				giaTriLonNhatDong = maTran[i][j];

		tongGiaTriLonNhatDong += giaTriLonNhatDong;
	}

	return tongGiaTriLonNhatDong;
}
