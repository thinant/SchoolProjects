...
void tinhTongDongTrenMaTran(MANG2D_THUC maTran, unsigned int soDong, unsigned int soCot, double mangTong[]);
...
int main()
{
	...
	tinhTongDongTrenMaTran(maTran, soDong, soCot, mangTong);

	printf("Tong moi dong trong ma tran la: ");
	xuatMangThuc(mangTong, soDong);
