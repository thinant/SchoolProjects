...
void tinhTongCotTrenMaTran(MANG2D_THUC maTran, unsigned int soDong, unsigned int soCot, double mangTong[]);
...
int main()
{
	...
	tinhTongCotTrenMaTran(maTran, soDong, soCot, mangTong);

	printf("Tong moi cot trong ma tran la: ");
	xuatMangThuc(mangTong, soCot);
