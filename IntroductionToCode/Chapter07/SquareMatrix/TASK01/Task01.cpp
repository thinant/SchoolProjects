...
void xuatDuongCheoChinhPhu(MANG2D_THUC maTran, unsigned int soDong);
...
int main()
{
	...
	xuatDuongCheoChinhPhu(maTran, soDong);
...
void xuatDuongCheoChinhPhu(MANG2D_THUC maTran, unsigned int soDong)
{
	...
	for (unsigned int i = 0; i < soDong; i++)
		printf("%lf ", maTran[i][i]);
	
	printf("\n\nPhan tu thuoc duong cheo phu la: ");
	for (unsigned int i = 0; i < soDong; i++)
		printf("%lf ", maTran[i][soDong - 1 - i]);
}
