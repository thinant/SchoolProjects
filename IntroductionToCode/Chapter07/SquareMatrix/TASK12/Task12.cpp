...
unsigned int demPhanTuNguyenToDuongCheoChinh(MANG2D_NGUYEN maTran, unsigned int soDong);
bool kiemTraSoNguyenTo(int so);

int main()
{
	MANG2D_NGUYEN maTran{ 0 };
	unsigned int soDong = 0, soPhanTuNguyenToDuongCheoChinh;
	...
	soPhanTuNguyenToDuongCheoChinh = demPhanTuNguyenToDuongCheoChinh(maTran, soDong);
	
	printf("Co %u phan tu nguyen to nam tren duong cheo chinh.", soPhanTuNguyenToDuongCheoChinh);
