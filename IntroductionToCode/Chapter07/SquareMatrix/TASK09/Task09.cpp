...
double tinhTongDuongCheoChinh(MANG2D_THUC maTran, unsigned int soDong);
...
int main()
{
	...
	tongDuongCheoChinh = tinhTongDuongCheoChinh(maTran, soDong);

	printf("Tong cac phan tu tren duong cheo chinh: %lf", tongDuongCheoChinh);
