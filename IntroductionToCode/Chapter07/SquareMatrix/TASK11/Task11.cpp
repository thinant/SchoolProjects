...
double tinhTongCacPhanTuNhoNhatDuongCheoPhu(MANG2D_THUC maTran, unsigned int soDong);

int main()
{
	MANG2D_THUC maTran{ 0 };
	unsigned int soDong = 0;
	double tongPhanTuNhoNhatCacDuongCheoPhu;
	...
	tongPhanTuNhoNhatCacDuongCheoPhu = tinhTongCacPhanTuNhoNhatDuongCheoPhu(maTran, soDong);

	printf("Tong cac phan tu nho nhat cua tung duong cheo phu la: %lf", tongPhanTuNhoNhatCacDuongCheoPhu);
